...
void ajouter()
 {
    ...
    Reservations[count].reference = refReservation;
...
void triParLeDate()
{
        ...
        for (int i = 0; i < count-1; i++)
        {
            for (int j = i+1; j < count; j++)
            {          
                 if (Reservations[i].laDate.jour > Reservations[j].laDate.jour)
                 {
        ...
        {   
            for (int j = i+1; j < count ; j++)
            {          
                 if (Reservations[i].laDate.mois > Reservations[j].laDate.mois )
                 {
                        reservation temp = Reservations[i];
                        Reservations[i] = Reservations[j];
                        Reservations[j] = temp;
        ...
        {   
            for (int j = i+1; j < count ; j++)
            {          
                 if (Reservations[i].laDate.annee > Reservations[j].laDate.annee )
                 {
                        reservation temp = Reservations[i];
                        Reservations[i] = Reservations[j];
                        Reservations[j] = temp;
...
void RecherchParleNome()
{
    ...
    for (int i = 0; i < count; i++)
    {
        if (strcmp(nome , Reservations[i].nom) == 0)
        {
        printf("\n");
        printf("_____\n");
        printf("\n");
